<template>
  <div class="min-h-screen flex items-center justify-center px-4 py-8" style="background-color: #f0f2f5;">
    <div class="w-full max-w-5xl">
      ...
      <!-- Main Card Container -->
      <div class="flex rounded-2xl overflow-hidden shadow-xl" style="min-height: 420px;">

        <!-- ===== LEFT COLUMN - BANNER ===== -->
        <div class="relative w-3/5 overflow-hidden" style="background: linear-gradient(135deg, #e8eef8 0%, #dce6f5 100%);">
          ...
          <!-- Logo overlay — di atas foto banner, pojok kiri atas -->
          <div class="absolute top-0 left-0 z-20 px-8 pt-7">
            <img src="/public/logo_asdp.png" alt="ASDP Logo" class="h-10 object-contain" />
          </div>

          <!-- Title text overlay — pojok kiri bawah -->
          <div class="absolute bottom-7 left-8 z-20" style="max-width: 400px;">
            <h1
        ...
        <!-- ===== RIGHT COLUMN - FORM ===== -->
        <div class="w-2/5 bg-white flex flex-col justify-center px-10 py-10">
